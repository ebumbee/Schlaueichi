...
const ALL_SENTENCES = [
  "Anni fliegt auf einer gelben Banane zum Mond.",
  "Malin reitet auf einer wilden Riesenerdbeere durch die Schule.",
  "Jakob tanzt mit einer nassen Socke auf dem Kopf.",
  "Julia füttert ein dickes Nilpferd mit scharfem Senf.",
  "Eva putzt die Zähne von einem lachenden Krokodil.",
  "Mila sucht ihre linke Socke im kalten Wackelpudding.",
  "Nael fliegt rückwärts auf einem schnellen Staubsauger.",
  "Kati tanzt lustig Polka mit einem grünen Frosch.",
  "Emil putzt die großen Zähne von einem Nilpferd.",
  "Olivia schläft gemütlich in einer Schüssel voller Müsli.",
  "Jano badet fröhlich in einer Badewanne voller Erdbeermus.",
  "Lukas baut ein buntes Schloss aus grünem Käse.",
  "Kajus kitzelt das freche Eichhörnchen an den Füßen.",
  "Rosalie trägt eine dicke Wassermelone als Ritterhelm.",
  "Elise fliegt mit einer riesigen Seifenblase zum Nordpol.",
  "Lena reitet rückwärts auf einer frechen Ziege.",
  "Elisabeth füttert ein hungriges Monster mit Schokosoße.",
  "Carl lacht laut über einen pupsenden Fisch.",
  "Liam trägt einen glänzenden Kochtopf als Hut.",
  "Richard rutscht lustig auf einer nassen Nudel aus.",
  "Sara spielt ein lautes Lied auf der Nasenflöte.",
  "Maxi quetscht eine saure Zitrone über seinem Kopf aus.",
  "Frau George fliegt auf einer Rakete aus buntem Karton.",
  "Anni kitzelt den großen Zeh von einem Riesen.",
  "Malin füttert den lieben Dino mit grünem Kaugummi.",
  "Jakob sucht seine Brille, obwohl sie auf seiner Nase sitzt.",
  "Julia versucht, auf einer Seifenblase Seil zu springen.",
  "Eva kitzelt einen kleinen Pinguin im Kühlschrank.",
  "Mila reitet auf einer wilden Riesenspinne durchs Bad.",
  "Nael isst seine langen Spaghetti mit den Fingern.",
  "Kati trägt eine rote Erdbeere als Clownsnase.",
  "Emil schläft heute im weichen Wäschekorb.",
  "Olivia telefoniert laut mit einer dicken Kartoffel.",
  "Jano putzt die Nase von einem frechen Affen.",
  "Lukas kitzelt einen schlafenden Biber am Fluss.",
  "Kajus sucht ein grünes Ufo im Gemüsebeet.",
  "Rosalie tanzt im Schlafanzug mit einer lustigen Kuh.",
  "Elise backt einen leckeren Kuchen aus matschigem Schlamm.",
  "Lena sucht den leuchtenden Mond unter ihrem Bett.",
  "Elisabeth reitet auf einem rosa, hüpfenden Känguru.",
  "Carl fliegt gemütlich auf einer dicken, weichen Wolke.",
  "Liam putzt die spitzen Zähne vom weißen Hai.",
  "Richard badet mit einer gelben Gummiente im Kakao.",
  "Sara lacht laut über ein watschelndes Huhn.",
  "Maxi füttert ein zahmes Pony mit süßen Bonbons.",
  "Frau George tanzt im glitzernden, pinken Tutu."
];
