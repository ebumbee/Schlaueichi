...
const ALL_SENTENCES = [
  "Mila kitzelt ein pupsendes Schwein.",
  "Anni fliegt auf einer Banane zum Mond.",
  "Jakob tanzt mit einer Socke auf dem Kopf.",
  "Julia füttert das Nilpferd mit Senf.",
  "Eva putzt die Zähne von einem Krokodil.",
  "Malin reitet auf einer wilden Erdbeere.",
  "Sara sucht ihre Nase im Kühlschrank.",
  "Mila backt einen großen Kuchen aus Matsch.",
  "Anni kitzelt den großen Zeh vom Riesen.",
  "Jakob putzt den Popo vom lieben Dino.",
  "Julia telefoniert mit einer grünen Gurke.",
  "Eva schläft in einer Riesenschüssel Müsli.",
  "Malin kitzelt eine schlafende Hummel am Bauch.",
  "Sara fliegt rückwärts auf einem Staubsauger.",
  "Mila unterhält sich mit einer frechen Socke.",
  "Jakob schläft gemütlich im Hundekorb von Bello.",
  "Anni reitet auf einer Schnecke um die Wette.",
  "Eva füttert die Katze mit sauren Gurken.",
  "Malin fängt eine Wolke mit dem Schmetterlingsnetz.",
  "Sara badet in einer Badewanne voller Wackelpudding.",
  "Julia tanzt lustig Polka mit einer Gans.",
  "Jakob baut ein buntes Haus aus grünem Käse.",
  "Mila malt einen roten Popo auf den Stuhl.",
  "Anni sucht ihren verlorenen Zeh im Sand.",
  "Eva füttert das hungrige Monster mit Schokosoße.",
  "Malin kitzelt ein fliegendes Einhorn.",
  "Sara spielt laut Flöte mit der Nase.",
  "Julia rutscht auf einer Bananenschale aus.",
  "Mila fliegt mit einer riesigen Seifenblase weg.",
  "Jakob trägt eine dicke Melone als Hut.",
  "Anni liest einem kleinen Wurm ein Märchen vor.",
  "Eva kitzelt das freche Eichhörnchen SchlauEichi.",
  "Malin putzt die Brille von einer klugen Eule.",
  "Sara baut ein Bett aus bunten Luftballons.",
  "Julia badet fröhlich in süßer Erdbeermilch.",
  "Jakob reitet rückwärts auf einer frechen Ziege.",
  "Mila fängt einen dicken, lachenden Fisch.",
  "Anni schläft auf einem Kissen aus Wackelpudding.",
  "Eva sucht den Schatz in ihrer linken Socke.",
  "Malin lacht laut über den pupsenden Frosch.",
  "Sara fliegt im Hubschrauber aus süßer Schokolade.",
  "Julia kitzelt den großen, schlafenden Löwen.",
  "Jakob tanzt im glitzernden, pinken Tutu.",
  "Mila baut einen echten Schneemann im Wohnzimmer.",
  "Anni reitet auf einem Teppich aus leckerer Pizza.",
  "Eva füttert einen Hai mit süßem Erdbeereis.",
  "Malin fliegt auf einem bunten, sprechenden Papagei.",
  "Sara sucht ihre Hose oben auf dem Dach.",
  "Julia macht lauter Quatsch mit einer reifen Banane.",
  "Jakob kitzelt eine sehr mürrische Krabbe.",
  "Mila schläft auf einem weichen, warmen Toastbrot.",
  "Anni isst ihre Suppe mit einer großen Gabel.",
  "Eva liest ein spannendes Buch auf dem Kopf.",
  "Malin fliegt mit einer dicken Pusteblume im Wind.",
  "Sara tanzt wild mit einer winzigen Ameise.",
  "Julia fährt heute Traktor im bunten Schlafanzug.",
  "Jakob wirft mit weichen, süßen Marshmallows.",
  "Mila badet in einer riesigen Suppenschüssel.",
  "Anni kitzelt einen dicken, grünen Frosch im Teich.",
  "Eva füttert die wilden Vögel mit Gummibärchen.",
  "Malin fliegt auf einer Rakete aus buntem Karton.",
  "Sara reitet auf einem rosa, hüpfenden Känguru.",
  "Julia putzt die spitzen Zähne vom weißen Hai.",
  "Jakob schläft müde auf einem großen Stapel Pizza.",
  "Mila sucht ein grünes Ufo im Gemüsebeet.",
  "Anni telefoniert laut mit einer dicken Kartoffel.",
  "Eva kitzelt einen müden, schlafenden Pandabären.",
  "Malin reitet auf einem wilden Besen durch die Luft.",
  "Sara isst ihre langen Spaghetti mit den Fingern.",
  "Julia fliegt gemütlich auf einer dicken, weichen Wolke.",
  "Jakob tanzt lustig mit einer frechen Spinne.",
  "Mila baut ein wunderschöne Schloss aus Keksen.",
  "Anni füttert das liebe Pony mit bunten Bonbons.",
  "Eva badet mit einer gelben Gummiente im warmen Kakao.",
  "Malin sucht den leuchtenden Mond unter ihrem Bett.",
  "Sara lacht laut über einen lustigen, frechen Affen.",
  "Julia backt einen leckeren Kuchen aus matschigem Schlamm.",
  "Jakob kitzelt einen schlafenden Biber am Fluss.",
  "Mila fliegt auf einer riesigen, roten Erdbeere.",
  "Anni reitet auf einem dicken, grauen Nilpferd.",
  "Eva schläft friedlich in einer großen, bunten Socke.",
  "Malin isst kaltes Vanilleeis mit scharfem Senf.",
  "Sara fliegt hoch auf einem großen, gelben Luftballon.",
  "Julia kitzelt eine sehr langsame, schlafende Schnecke.",
  "Jakob sucht seine Brille, obwohl sie auf der Nase sitzt.",
  "Mila tanzt fröhlich mit einer gefleckten Kuh.",
  "Anni füttert die hohe Giraffe mit langen Nudeln.",
  "Eva baut eine riesige Burg aus süßen Waffeln.",
  "Malin kitzelt das freche Eichhörnchen an den Füßen.",
  "Sara fliegt mit einem dicken, bunten Vogel weg.",
  "Julia reitet auf einem fliegenden, rosa Schweinchen.",
  "Jakob schläft tief im Beutel vom Känguru.",
  "Mila kitzelt das schlafende, faule Faultier.",
  "Anni fängt eine helle Sternschnuppe mit ihrem Hut.",
  "Eva rutscht blitzschnell auf der Regenbogen-Rutsche.",
  "Malin tanzt im Kreis mit einem netten Gespenst.",
  "Sara liest ein lustiges Buch für ihren Hund vor.",
  "Julia badet fröhlich in flüssiger Schokolade.",
  "Jakob kitzelt den großen, wilden Tiger am Bauch.",
  "Mila quetscht eine ganze Zitrone auf Jakobs Kopf.",
  "Anni wirft eine Sahnetorte direkt in Julias Gesicht.",
  "Sara lacht, weil Eva rückwärts die Treppe hochläuft.",
  "Malin füttert den dicken Dino mit grünem Kaugummi.",
  "Jakob balanciert eine dicke Torte auf seiner Nase.",
  "Julia versucht, auf einer Seifenblase Seilzuspringen.",
  "Eva kitzelt einen kleinen Pinguin im Kühlschrank.",
  "Mila reitet auf einer wilden Riesenspinne durchs Zimmer.",
  "Anni putzt die Zähne von einer lachenden Gans.",
  "Sara trägt eine rote Erdbeere als Clownsnase.",
  "Malin schläft heute im weichen Wäschekorb.",
  "Jano putzt die Nase von einem frechen Affen.",
  "Jano fliegt rückwärts auf einem fliegenden Teppich.",
  "Jano badet in einer Badewanne voller Erdbeermus.",
  "Jano kitzelt einen dicken, lachenden Dino am Bauch.",
  "Jona tanzt im Schlafanzug mit einer lustigen Kuh.",
  "Jona balanciert eine Gurke auf seiner Nase.",
  "Jona sucht ein grünes Ufo unter seinem Kopfkissen.",
  "Jona füttert das Krokodil mit süßem Schokokeks.",
  "Bent reitet auf einem rosa, springenden Känguru.",
  "Bent telefoniert laut mit einer dicken Tomate.",
  "Bent baut ein großes Haus aus weichem Wackelpudding.",
  "Bent kitzelt einen müden Löwen unter den Pfoten.",
  "Liam fliegt mit einer riesigen Seifenblase zum Nordpol.",
  "Liam putzt die Zähne von einem rosa Nilpferd.",
  "Liam trägt einen Kochtopf als Ritterhelm auf dem Kopf.",
  "Liam rutscht lustig auf einer nassen Nudel aus."
];
